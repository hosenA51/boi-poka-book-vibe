        ...
        <div className="card lg:card-side flex my-20">
            ...
            <div className="card-body flex-1 p-0 ml-8">
                ...
                <div className='flex gap-4'>
                    <button className="btn btn-outline btn-accent font-semibold text-black px-4">Read</button>
                    <button className="btn bg-[#50B1C9] font-semibold text-white px-6">Wishlist</button>
                </div>
            </div>
        </div>
    );
